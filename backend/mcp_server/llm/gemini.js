...
var GeminiAgent = /** @class */ (function () {
    function GeminiAgent(model) {
        this.useMockResponses = false;
        try {
            // Check if Gemini API key is available
            var apiKey = process.env.VITE_GEMINI_KEY;
            if (apiKey) {
                this.agent = new genai_1.GoogleGenAI({ apiKey: apiKey });
    ...
    GeminiAgent.prototype.ask = function (query, thinking) {
        return __awaiter(this, void 0, void 0, function () {
            var mockText, response, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(this.useMockResponses || !this.agent)) return [3 /*break*/, 1];
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.agent.models.generateContent({
